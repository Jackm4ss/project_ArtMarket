...
const heroContent = {
  ...
  actions: [
    { id: "hero-explore-btn", href: "#gallery", label: "Jelajahi Koleksi", icon: ArrowRight, variant: "primary" },
    { id: "hero-artist-btn", href: "#value", label: "Daftar Seniman", icon: ArrowUpRight, variant: "outline" },
  ],
  stats: [
