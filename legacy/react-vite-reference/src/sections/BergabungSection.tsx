...
const ctaContent = {
  ...
  actions: [
    { id: "cta-buyer-btn", href: "#gallery", label: "Daftar Sebagai Pembeli", icon: ShoppingBag, variant: "primary" },
    { id: "cta-seller-btn", href: "#value", label: "Jadi Seniman", icon: Palette, variant: "gold-outline" },
  ],
} as const;
