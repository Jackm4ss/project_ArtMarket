...
const genres = [
  ...
  },
  {
    ...
    count: "380+ karya",
    href: "/katalog?category=kerajinan-seni",
    image: {
  ...
  },
  {
    ...
    count: "290+ karya",
    href: "/katalog?category=dekorasi-artistik",
    image: {
    ...
    <Section id="genres" compact className="bg-cream lg:flex lg:min-h-screen lg:items-center">
      <Container data-nav-anchor className="w-full">
        <div className="mb-12 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <a id="genres-viewall-link" href="/katalog" className={cx("group inline-flex items-center gap-2 text-sm font-medium text-gold-dark transition-colors hover:text-gold", ui.focus)}>
